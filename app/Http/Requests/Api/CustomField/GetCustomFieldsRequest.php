...
#[OA\Parameter(
    parameter: 'GetCustomFields_CursorParam',
    name: 'cursor',
...
#[OA\Parameter(
    parameter: 'GetCustomFields_LimitParam',
    name: 'limit',
...
#[OA\Parameter(
    parameter: 'GetCustomFields_DirectionParam',
    name: 'direction',
    description: 'Pagination direction',
    in: 'query',
    schema: new OA\Schema(type: 'string', default: 'down', enum: ['up', 'down'])
)]
class GetCustomFieldsRequest extends FormRequest
{
